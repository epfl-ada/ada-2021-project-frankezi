...
After receiving the feedback of the Milestone 2, we change our plans and decided to use the tool VADER (Valence  Aware  Dictionary  for  sEntiment  Rea-soning).
